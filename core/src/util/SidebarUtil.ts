import type {Endpoint, SidebarEndpointItemDto, SidebarGroupItemDto, SidebarItemDto, SidebarLinkItemDto} from "../type";
...
function pageTreeToSidebar(nodes: PageNode[]): (SidebarGroupItemDto|SidebarLinkItemDto)[] {
